...
const ADD_OPTIONS = [
  ["OPC UA", "Bioreactors, SCADA, MES equipment"],
  ["SiLA 2", "Lab instruments (control + data)"],
...
.cp-head{display:flex;justify-content:space-between;align-items:flex-start;gap:16px;margin-bottom:18px;}
.cp-t{font-size:20px;font-weight:600;letter-spacing:-.01em;margin:0;}
.cp-d{font-size:13px;color:#69727C;max-width:660px;line-height:1.5;margin:5px 0 0;}
.cp-d b{color:#1B2229;font-weight:600;}
          ...
          {isAdd ? (
            <>
              <p style={{ fontSize: 12.5, color: "#69727C", lineHeight: 1.5, marginTop: 12 }}>
                Connect a new system through an open standard — the layer sits on top of it, nothing gets replaced.
              </p>
    ...
    <div className="cp">
      ...
      <div className="cp-head">
        <div>
          ...
          <p className="cp-d">Collecting data from every part of the process — strain engineering through downstream — over open standards, sitting on top of existing systems so nothing is replaced. <b>OPC UA</b> for bioreactor data (temperature, pH, dissolved oxygen, feed rates), <b>AnIML + SiLA</b> for lab instruments, and <b>APIs</b> for ELNs, spreadsheets, and LIMS.</p>
        </div>
