...
.db-t{font-size:20px;font-weight:600;letter-spacing:-.01em;margin:0;}
.db-d{font-size:13px;color:#69727C;max-width:660px;line-height:1.5;margin:5px 0 18px;}
...
export default function DataBrowserPage() {
  ...
  return (
    <div className="db">
      <style>{css}</style>
      <div><h1 className="db-t">Data browser</h1>
        <p className="db-d">The underlying records behind the graph — the warehouse view that holds the high-volume numbers. Gold marks fermentation runs inside the DO sweet spot.</p></div>
